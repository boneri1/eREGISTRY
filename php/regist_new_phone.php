...
<center>
	...
	<form action="regist_new_phone.php" method="POST">
      ...
      <table>
          ...
          <tr id="second">
        	<td>Second Imei:</td>
        	<td><input type="text" name="secondImei"></td>
         </tr>
   ...
   if(isset($_POST['ok'])){
    ...
    $gmail=$_POST['email'];
    $insert=mysqli_query($conn,"INSERT INTO `phone` (`PhoneId`, `ImeiNumber_1`, `ImeiNumber_2`, `Brand`, `Model`, `DateOfPurchase`, `priceOfPhone` ,`Description`, `PhoneStatus`, `Email`) 
    VALUES (NULL, '$firstImei', '$secondImei', '$brand', '$model', '$dateOfPurchase',`$priceOfPhone` , '$description', '$phonestatus', '$gmail')");
    if($insert){
